...
abm <- make_cooperation_model(migration_rate = 0.02, coop_benefit = 1, coop_cost = 0.2)
# migration(abm)

trial <- run_trial(abm, stop = 70)
p <- plot_prevalence(trial, tracked_behaviors = c("Cooperate"))
print(p)
